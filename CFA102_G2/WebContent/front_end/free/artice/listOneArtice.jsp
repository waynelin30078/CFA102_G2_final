            ...
            <div class="row">
                    <div class="text" style="width: 600px;padding-right: 13px;padding-left: 18px;text-align: justify;font-size: 15px;">
                       <div class="content" style="word-break:break-all">
                        <p style="margin-left: 0px; font-size:25px ;color:gray; border-style: none;">${articeVO.articContent}</p>
                        </div>
                        <div style="width: 200px; height:200px;">
                    <img class="rounded" src="<%=request.getContextPath()%>/PicFinder?pic=1&table=article&column=articPhoto1&idname=articNo&id=${articeVO.articNo}">                     
                        <p class="text-left">發布時間 :<fmt:formatDate value="${articeVO.articDate}" pattern="yyyy-MM-dd"/></p>
                    </div>
                    </div>
                </div>
            </div>

...
<head>
    ...
    <link href="<%= request.getContextPath() %>/back_end_example/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link
        href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i"
        rel="stylesheet">

    <!-- Custom styles for this template-->
    <link href="<%= request.getContextPath() %>/back_end_example/css/sb-admin-2.min.css" rel="stylesheet">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo"
                    ...
                    <span style=font-size:19px>員工管理</span>
                </a>
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">員工系統管理</h6>
                        <a class="collapse-item" href="buttons.html">員工帳號管理</a>
                        <a class="collapse-item" href="cards.html">員工權限管理</a>
                    </div>
                </div>
            </li>
            <hr class="sidebar-divider">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<%=request.getContextPath()%>/news/select_news_page">最新訊息管理</a>
            ...
            <li class="nav-item ">
                ...
                <div id="collapsePages" class="collapse show" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="login.html">訂單管理</a>
                        <a class="collapse-item" href="register.html">優惠活動管理</a>
                        <a class="collapse-item" href="forgot-password.html">商品管理</a>

                        <a class="collapse-item" href="404.html">商品金流管理</a>
                        <a class="collapse-item" href="blank.html">飲食日記管理</a>
                    </div>
                </div>
            </li>
            <hr class="sidebar-divider">

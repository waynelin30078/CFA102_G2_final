...
<table>
	...
	<tr>
		<td>文章內容:</td>
		<td><input type="TEXT" style="width:400px; height:280px" name="articContent1" size="30" value="<%=articeVO.getArticContent()%>" /></td>
	</tr>
	<tr>		
		<td>
	...
	<tr>
		<td>文章圖片:</td>
		<td>
		<img id="image"  width="400px" height="280px" src="<%=request.getContextPath()%>/PicFinder?pic=1&table=article&column=articPhoto1&idname=articno&id=<%=articeVO.getArticNo()%>" />
    	<input type="file" id="upload" onchange="loadImageFile(event)" name="articPhoto" accept="image/gif, image/jpeg, image/png">
		</td>
	</tr>
	
		<jsp:useBean id="articSvc" scope="page" class="com.artice.model.ArticeService" />

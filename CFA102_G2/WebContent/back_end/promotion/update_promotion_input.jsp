...
<body id="page-top">
	...
	<div class="container-fluid">
		<h1 class="h3 mb-4 text-gray-800">修改商品優惠活動</h1>
		...
		<div class="row col-md-12 col-md-offset-2 custyle">
    		<a href="<%=request.getContextPath()%>/back_end/promotion/select_page.jsp" class="btn btn-primary btn-xs pull-right" id="btnback">
    			<i class="far fa-hand-point-left"></i> 回商品優惠活動管理</a>	
    	</div>

        <div class="row col-md-12 col-md-offset-2 custyle">	
			<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/promotion/promotion.do" name="form1">
				<table class="table table-striped custab">
					...
					<tr>
						<td>優惠活動名稱:</td>
						<td><input type="TEXT" name="promName" size="50" value="<%=promotionVO.getPromName()%>" /></td>
					</tr>
					<tr>
						<td>開始日期:</td>
						<td><input name="promStartDate" id="f_date1" type="text" value="<%=promotionVO.getPromStartDate()%>" /></td>
					</tr>
					<tr>
						<td>結束日期:</td>
						<td><input name="promEndDate" id="f_date2" type="text" value="<%=promotionVO.getPromEndDate()%>" /></td>
					</tr>
				</table>
				<br>
				<input type="hidden" name="action" value="update">
				<input type="hidden" name="promNo" value="<%=promotionVO.getPromNo()%>">
...
<script>
        ...
        $('#f_date1').datetimepicker({
           theme: '',              //theme: 'dark',
 		   ...
 		   value: '<%=promotionVO.getPromStartDate()%>' // ,value:   new Date(),
        ...
        $('#f_date2').datetimepicker({
           theme: '',              //theme: 'dark',
 	       ...
 	       step: 1,                //step: 60 (這是timepicker的預設間隔60分鐘)
 	       format:'Y-m-d',         //format:'Y-m-d H:i:s',
 		   value: '<%=promotionVO.getPromEndDate()%>' // ,value:   new Date(),
           //disabledDates:        ['2017/06/08','2017/06/09','2017/06/10'], // 去除特定不含
           //startDate:	            '2017/07/10',  // 起始日
           //minDate:               '-1970-01-01', // 去除今日(不含)之前
           //maxDate:               '+1970-01-01'  // 去除今日(不含)之後

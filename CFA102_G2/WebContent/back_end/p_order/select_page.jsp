...
<body id="page-top">
	...
	<div class="container-fluid">
		<h1 class="h1 mb-4 text-gray-800">訂單管理</h1>
		<h4 class="h4 mb-2 text-gray-800">列表:</h4>
  		<div class="row">
    		<div class="col-12 col-sm-12 col-md-12 col-lg-6 col-lg-6">
    			<div class="list-group">
  					<a href="<%=request.getContextPath()%>/back_end/p_order/listAllP_order.jsp"
     		   		   class="list-group-item list-group-item-action">● 訂單列表
  					</a>
				</div> 
    		</div>	
    	</div>
  		...
  		<div class="row">
    		<div class="col-12 col-sm-12 col-md-12 col-lg-6 col-lg-6">
    			<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/p_order/p_order.do" name="form1">
					<ul class="list-group">
  						<li class="list-group-item">輸入訂單編號 (如1):
        					<input type="text" name="porderNo" autocomplete="off">
  						</li>
  						<li class="list-group-item">輸入會員編號 (如1):
        					<input type="text" name="mno" autocomplete="off">
  						</li>
   						<li class="list-group-item">訂單成立期間:
							<input type="text" name="porderDate" id="f_date1" size="10" autocomplete="off">
 							<b>至</b>
							<input type="text" name="porderDate1" id="f_date2" size="10" autocomplete="off">	
						</li>
  						<li class="list-group-item">訂單金額:
							<input type="text" name="porderTotal" value="" size="5" autocomplete="off">
 							<b>至</b>
							<input type="text" name="porderTotal1" value="" size="5" autocomplete="off">			
						</li>
  						<li class="list-group-item">訂單狀態:
							<select size="1" name="porderState">
						...
						<li class="list-group-item">
							<input type="submit" class="btn btn-outline-primary btn-sm" value="送出">
       						<input type="hidden" name="action" value="listP_order_ByCompositeQuery">
						</li>										
					</ul>
				</FORM>
    		</div>
